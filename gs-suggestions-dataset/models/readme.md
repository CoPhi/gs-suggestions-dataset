...
Esempio: 
       ...
       python models/nltk/trigram_nltk.py train
...
Esempio: 
       ...
       ```sh       
       python models/nltk/trigram_nltk.py infer --context "parole di esempio" --num_words 5
       ```
...
Esegui lo script con l'argomento `eval` per valutare il modello secondo le metriche di perplessità e accuracy: 
Esempio: 

       ```sh
       python models/nltk/trigram_nltk.py eval
       ```
