...
from models.ngrams.train.training import get_sentences
from backend.config.settings import N, LAMBDA
from math import pow
from models.ngrams.inference.predict import interpolated_log_score
...
def interpolated_entropy(
    ...
    for sent in ngrams:
        ...
        for ngram in valid_ngrams:
            total_log_prob += interpolated_log_score(g_lm, d_lm, ngram[-1], list(ngram[:-1]), lambda_weight)
            total_token_count += 1
